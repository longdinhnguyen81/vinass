	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 600, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': false }, 'bullets': {'enable': false, 'style': 'bullets-style-2 bullets-color-primary', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-bg-8.jpg"  
									alt=""
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.6;s:500;"><img src="/templates/vinass/img/slides/slide-title-border-light.png" alt=""></div>
						...
						<div class="row align-items-center">
							...
							<div class="col-lg-4">
								<div class="get-started text-left text-lg-right">
									...
									<div class="learn-more">or <a href="/" class="font-weight-bold">learn more.</a></div>
								</div>
							</div>
						</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center pb-4 pb-lg-0">
							...
							<div class="col-9 col-lg-6 order-1 order-lg-2 scale-6 pb-5 pb-lg-0 mt-0 mt-md-4 mb-5 mb-lg-0">
								<img class="img-fluid appear-animation" src="/templates/vinass/img/desktop-device-1.png" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300" data-plugin-options="{'accY': -400}" alt="">
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section section-height-3 section-background border-0 m-0 appear-animation" data-appear-animation="fadeIn" style="background-image: url(/templates/vinass/img/parallax/parallax-10.jpg); background-size: cover; background-position: center;">
					<div class="container">
						<div class="row">
					...
					<div class="row py-5 my-4">
						<div class="col-md-6 mb-4 mb-lg-0">
							<a href="/" class="logo pr-0 pr-lg-3">
								<img alt="Porto Website Template" src="/templates/vinass/img/logo.png" class="opacity-7 bottom-4" height="33">
							</a>
