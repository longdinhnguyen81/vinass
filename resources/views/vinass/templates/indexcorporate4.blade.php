						...
						<ul>
							<li data-transition="fade" class="slide-overlay slide-overlay-level-7">
								...
								<div class="tp-caption font-weight-light text-center"
									...
									style="color: #b5b5b5;">Trusted by over <strong class="text-color-light">30,000</strong> satisfied users, VINASOFT is a huge sucess in the of<br>one of the world's largest MarketPlace.</div>
