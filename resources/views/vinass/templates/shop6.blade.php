...
<head>
   ...
   <!-- Basic -->
        ...
        <link rel="apple-touch-icon" href="/templates/vinass/img/apple-touch-icon.png">s
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a ><img src="/templates/vinass/shop/images6/flags/en.png" alt="England flag">ENGLISH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a ><img src="/templates/vinass/shop/images6/flags/en.png" alt="England flag">ENGLISH</a></li>
                                    <li><a ><img src="/templates/vinass/shop/images6/flags/fr.png" alt="France flag">FRENCH</a></li>
                                </ul>
                            </div><!-- End .header-menu -->
                        </div><!-- End .header-dropown -->
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        <a  href="/" class="logo">
                            <img src="/templates/vinass/img/logo-blue.png" width="150px" height="50px" alt="Vinasoft Logo">
                        </a>
                    </div><!-- End .header-left -->
                        ...
                        <div class="home-slide">
                            ...
                            <div class="container">
                                <div class="home-slide-content">
                                    ...
                                    <a  class="btn btn-secondary">Shop Now</a>
