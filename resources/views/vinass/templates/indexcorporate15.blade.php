...
<!-- Revolution Slider Addon - Typewriter -->
		<link rel="stylesheet" type="text/css" href="/templates/vinass/vendor/rs-plugin/revolution-addons/typewriter/css/typewriter.css" />
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-15.css"> 
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'fullScreenOffsetContainer': '#header', 'delay': 9000, 'gridwidth': [1410,1110,930,690], 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1422,1182,974], 'navigation' : {'arrows': { 'enable': true, 'style': 'metis arrows-primary arrows-rounded' }, 'bullets': {'enable': false}}}">
						<ul>
							<li data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-bg-light-1.jpg"  
									alt=""
								...
								<div class="tp-caption tp-resizeme d-none d-sm-block"
								    ...
								    data-width="['auto']"
									data-height="['auto']"
									data-basealign="grid"><img src="/templates/vinass/img/slides/slide-corporate-15-1.png" alt=""></div>
								...
								<div class="tp-caption tp-resizeme d-none d-sm-block"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
									data-basealign="grid"><img src="/templates/vinass/img/slides/circle.png" alt=""></div>

								<div class="tp-caption overlay d-none d-sm-block d-lg-none overlay-show overlay-color-secondary overlay-op-8"
									data-frames='[{"delay":0}]'
									data-x="center"
									data-y="center"
									data-height="1000"
								...
								<h1 class="tp-caption font-weight-extra-bold text-color-dark line ws-normal"
									...
									data-textAlign="['left','left','left','center']">Hey, welcome to our amazing office.</h1>
							...
							<li data-transition="fade">
								...
								<div class="tp-caption tp-resizeme d-none d-sm-block"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
									data-basealign="grid"><img src="/templates/vinass/img/slides/slide-corporate-15-2.png" alt=""></div>
								...
								<h1 class="tp-caption font-weight-extra-bold text-color-dark line ws-normal"
									...
									data-fontsize="['48','48','48','48']"
									data-lineheight="['55','55','55','55']"
									data-textAlign="['left','left','left','center']">We can help you with your project.</h1>
						...
						<div class="col-md-10 px-lg-5">
							<div class="row">
								<div class="col-md-6 mb-2 pb-2 px-2 appear-animation" data-appear-animation="fadeInRightShorter">
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											<img src="/templates/vinass/img/office/our-office-9.jpg" class="img-fluid" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">VIEW OUR SERVICES <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
								...
								<div class="col-md-6 mb-2 pb-2 px-2 appear-animation" data-appear-animation="fadeInLeftShorter">
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											<img src="/templates/vinass/img/office/our-office-10.jpg" class="img-fluid" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-slide-info-hover-1">
								...
								<div class="col-md-4 mb-2 pb-2 px-2 appear-animation" data-appear-animation="fadeInLeftShorter">
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											<img src="/templates/vinass/img/office/our-office-11.jpg" class="img-fluid" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-slide-info-hover-1">
								...
								<div class="col-md-4 mb-2 pb-2 px-2 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											<img src="/templates/vinass/img/office/our-office-12.jpg" class="img-fluid" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-slide-info-hover-1">
								...
								<div class="col-md-4 px-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											<img src="/templates/vinass/img/office/our-office-13.jpg" class="img-fluid" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-slide-info-hover-1">
								...
								<div class="col-lg-6">
									<div class="featured-boxes featured-boxes-modern-style-1">
										<div class="featured-box overlay overlay-show overlay-op-9 border-radius border-0">
											<div class="featured-box-background" style="background-image: url(/templates/vinass/img/gallery/gallery-11.jpg); background-size: cover; background-position: center;"></div>
											<div class="box-content px-lg-4 px-xl-5 py-lg-5">
												<div class="py-5 my-4">
													<a class="text-decoration-none lightbox" href="https://vimeo.com/45830194" data-plugin-options="{'type':'iframe'}">
														<img class="icon-animated" width="60" src="/templates/vinass/vendor/linea-icons/music/music_play_button.svg" alt="" data-icon data-plugin-options="{'color': '#FFF', 'animated': true, 'delay': 600, 'strokeBased': true}" />
													</a>
												</div>
											</div>
										</div>
				...
				<div class="container">
					<div class="row py-5 justify-content-center">
						...
						<div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center text-lg-right">
							...
							<p class="text-8 text-color-dark font-weight-bold pb-1 mb-0">(800) 123-4567</p>
							<p class="m-0"><a href="mailto:mail@example.com" class="text-color-dark">mail@example.com</a></p>
						</div>
					</div>
				</div>
