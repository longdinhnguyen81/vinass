...
<html>
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-17.css"> 
							...
							<div class="header-column justify-content-start d-lg-none">
								<div class="header-row mt-2">
									<div class="header-logo">
										<a href="index.html">
											<img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="0" src="/templates/vinass/img/logo.png">
										</a>
									</div>
								</div>
							</div>
													...
													<li class="align-items-center d-none d-lg-flex order-5 px-5 mx-2">
														<span class="header-logo">
															<a href="index.html" class="w-100 text-center">
																<img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" data-sticky-top="72" src="/templates/vinass/img/logo.png">
															</a>
														</span>
													</li>
												</ul>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-4 pl-lg-0 pr-lg-2 mb-3 appear-animation" data-appear-animation="fadeInRightShorter">
							<span class="thumb-info thumb-info-no-borders thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom">
								<span class="thumb-info-wrapper overlay overlay-show overlay-op-8">
									<img src="/templates/vinass/img/gallery/gallery-8.jpg" class="img-fluid" alt="">
									<span class="thumb-info-title background-transparent mb-4 pl-4 ml-2">
						...
						<div class="col-lg-4 px-lg-1 mb-3 appear-animation" data-appear-animation="fadeInDownShorter" data-appear-animation-delay="600">
							<span class="thumb-info thumb-info-no-borders thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom">
								<span class="thumb-info-wrapper overlay overlay-show overlay-op-8">
									<img src="/templates/vinass/img/gallery/gallery-9.jpg" class="img-fluid" alt="">
									<span class="thumb-info-title background-transparent mb-4 pl-4 ml-2">
										<span class="thumb-info-type font-weight-light text-1 line-height-1 opacity-8">LOREM IPSUM DOLOR SIT</span>
										<span class="thumb-info-inner font-weight-bold text-4 line-height-4">Brand Solutions</span>
										<span class="thumb-info-show-more-content pr-3">
											<p class="mb-0 text-1 line-height-9 pr-5 mr-5 mb-3 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc. Vivamus bibendum magna ex.</p>
											<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-2 btn-py-1 text-1 rounded"><span class="text-2 py-1 pl-2">LEARN MORE</span> <i class="fa fa-arrow-right ml-2 mr-2 pl-4 text-3"></i></a>
										</span>
						...
						<div class="col-lg-4 pr-lg-0 pl-lg-2 mb-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
							<span class="thumb-info thumb-info-no-borders thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom">
								<span class="thumb-info-wrapper overlay overlay-show overlay-op-8">
									<img src="/templates/vinass/img/gallery/gallery-10.jpg" class="img-fluid" alt="">
									<span class="thumb-info-title background-transparent mb-4 pl-4 ml-2">
										<span class="thumb-info-type font-weight-light text-1 line-height-1 opacity-8">LOREM IPSUM DOLOR SIT</span>
										<span class="thumb-info-inner font-weight-bold text-4 line-height-4">Mobile Apps</span>
										<span class="thumb-info-show-more-content pr-3">
											<p class="mb-0 text-1 line-height-9 pr-5 mr-5 mb-3 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc. Vivamus bibendum magna ex.</p>
											<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-2 btn-py-1 text-1 rounded"><span class="text-2 py-1 pl-2">LEARN MORE</span> <i class="fa fa-arrow-right ml-2 mr-2 pl-4 text-3"></i></a>
										</span>
				...
				<div class="container">
					<div class="row" style="margin-top: -165px">
						<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
							...
							<div class="card flip-card flip-card-3d bg-transparent text-center rounded-0">
								...
								<div class="flip-back d-flex align-items-center p-5" style="background-image: url(/templates/vinass/img/generic/generic-corporate-17-1.jpg); background-size: cover; background-position: center;">
									<div class="flip-content my-4">
					...
					<div class="row text-center text-md-left align-items-center mt-4 appear-animation mt-5" data-appear-animation="fadeInRightShorter">
						...
						<div class="col-md-5 col-lg-4 px-5 px-md-3">
							<img class="img-fluid" src="/templates/vinass/img/generic/generic-corporate-17-2.png" alt="" />
						</div>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-md-3 col-lg-3">
								<div class="call-to-action-btn">
									<a class="btn btn-badge btn-primary font-weight-bold px-4 mt-4 mt-md-2 mb-2" href="#">BUY NOW<span class="badge badge-dark badge-sm badge-pill text-uppercase px-2 py-1">Only $17</span></a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row pt-4">
							...
							<div class="process process-vertical pt-4">
								<div class="process-step appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
									...
									<div class="process-step-content">
										<h4 class="mb-1 text-4 font-weight-bold">Getting Started</h4>
										<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc. Vivamus bibendum ma Nullam id varius nunc. </p>
									</div>
								</div>
								<div class="process-step appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
									...
									<div class="process-step-content">
										<h4 class="mb-1 text-4 font-weight-bold">Learn About Us</h4>
										<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit masbendum ma Nullam id varius nunc. Vivamus bibendum magna ex, et faucibus lacus venenatis eget</p>
									</div>
								</div>
								<div class="process-step appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
									...
									<div class="process-step-content">
										<h4 class="mb-1 text-4 font-weight-bold">View Our Projects</h4>
										<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius nunc. Vivamus bib</p>
									</div>
								</div>
								<div class="process-step pb-4 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
									...
									<div class="process-step-content">
										<h4 class="mb-1 text-4 font-weight-bold">Contact Us</h4>
										<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim.</p>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 px-5 pt-2 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
							<div class="testimonial testimonial-style-7 testimonial-primary py-5 mt-4">
								...
								<a class="btn btn-outline btn-light text-light font-weight-bold mb-3" href="#">LEARN MORE</a>
							</div>
						</div>
				...
				<div class="container py-5">
					<div class="row justify-content-md-center py-4 mt-3">
						<div class="col-md-12 col-lg-3 d-flex align-items-center justify-content-center justify-content-lg-start mb-5 mb-lg-0">
							<a href="index.html"><img src="/templates/vinass/img/logo-dark.png" alt="Logo" class="img-fluid" style="max-width: 110px;"></a>
						</div>
						...
						<div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
							...
							<p class="text-8 text-color-light font-weight-bold mb-2">(800) 123-4567</p>
					...
					<div class="container py-2">
						<div class="row py-4">
							<div class="col d-flex align-items-center justify-content-center mb-4 mb-lg-0">
								<p class="font-weight-semibold text-3">© Copyright 2019. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
