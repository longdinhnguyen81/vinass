...
<!DOCTYPE html>
<html data-style-switcher-options="{'changeLogo': false, 'borderRadius': 0, 'colorPrimary': '#b3642a', 'colorSecondary': '#C06B2D', 'colorTertiary': '#e9e9e9', 'colorQuaternary': '#161b29'}">
	<head>
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/demos/demo-education.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-education.css">
	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider manual" data-version="5.4.8">
						<ul>
							<li data-transition="fade">
								<img src="/templates/vinass/img/demos/education/slides/slide-1.jpg"  
									alt=""
							...
							<li data-transition="fade">
								<img src="/templates/vinass/img/demos/education/slides/slide-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
				...
				<section class="section parallax section-parallax my-0 border-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '125%'}" data-image-src="/templates/vinass/img/demos/education/parallax/parallax-1.jpg">
					<div class="container">
						<div class="row">
							<div class="col-md-9 col-lg-7 col-xl-6 appear-animation" data-appear-animation="fadeInLeftShorter">
								<div class="card">
									<div class="card-body p-5">
										...
										<span id="countdown" data-countdown-date="2020/06/10 12:00:00" class="text-color-primary font-weight-semibold custom-countdown-style-1 justify-content-center mb-4"></span>
										<form id="registerForm" class="custom-form-style-1" action="#" method="post">
											<div class="form-row">
										...
										<div class="col-lg-10">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes custom-testimonial-style-1">
												...
												<div class="testimonial-author">
													<img src="/templates/vinass/img/demos/education/authors/author-1.jpg" class="img-fluid rounded-circle" alt />
													<p>
									...
									<div class="row justify-content-center">
										<div class="col-lg-10">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes custom-testimonial-style-1">
												...
												<div class="testimonial-author">
													<img src="/templates/vinass/img/demos/education/authors/author-2.jpg" class="img-fluid rounded-circle" alt />
													<p>
				...
				<section class="section parallax section-parallax my-0 border-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '125%'}" data-image-src="/templates/vinass/img/demos/education/parallax/parallax-2.jpg">
							...
							<div class="col-md-10 col-lg-7 offset-md-2 offset-lg-5">
									...
									<div class="col">
										<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
											<div class="feature-box-icon mt-3">
												<img src="/templates/vinass/img/demos/education/icons/icon-1.png" class="img-fluid" width="60" alt="" />
											</div>
								...
								<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
									<div class="col">
										<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
											<div class="feature-box-icon mt-3">
												<img src="/templates/vinass/img/demos/education/icons/icon-2.png" class="img-fluid" width="60" alt="" />
											</div>
											<div class="feature-box-info">
								...
								<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
									<div class="col">
										<div class="feature-box feature-box-style-2 custom-feature-box-style-1">
											<div class="feature-box-icon mt-3">
												<img src="/templates/vinass/img/demos/education/icons/icon-3.png" class="img-fluid" width="60" alt="" />
											</div>
											<div class="feature-box-info">
			...
			<footer id="footer" class="bg-color-quaternary border-top-0 mt-0">
				...
				<div class="footer-copyright bg-color-quaternary border-top-0">
					<div class="container">
						<div class="row">
							<div class="col">
								<p class="text-center">Vinasoft Solution © Copyright 2018. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<script src="/templates/vinass/vendor/jquery.countdown/jquery.countdown.min.js"></script>
		...
		<!-- Demo -->
		<script src="/templates/vinass/js/demos/demo-education.js"></script>
