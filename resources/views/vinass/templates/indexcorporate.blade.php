	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 670, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }, 'navigation' : {'arrows': { 'enable': false }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li class="slide-overlay slide-overlay-primary" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-corporate-1-1.jpg"  
									alt=""
							...
							<li class="slide-overlay" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-corporate-1-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
				...
				<section class="section section-parallax section-height-3 border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 7, 'parallaxHeight': '150%', 'offset': 100}" data-image-src="/templates/vinass/img/parallax/parallax-corporate-1-1.jpg">
				...
				<div class="container">
					...
					<div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
						<div class="col-md-4 mb-4 mb-md-0">
							<img class="img-fluid scale-2 pr-5 pr-md-0 my-4" src="/templates/vinass/img/layout-styles.png" alt="layout styles" />
						</div>
					...
					<div class="row align-items-center py-5 appear-animation" data-appear-animation="fadeInRightShorter">
						...
						<div class="col-md-4 px-5 px-md-3">
							<img class="img-fluid scale-2 my-4" src="/templates/vinass/img/style-switcher.png" alt="style switcher" />
						</div>
					</div>
			...
			<footer id="footer" class="border-0" style="background: url('/templates/vinass/img/parallax/parallax-8.jpg'); background-size:cover; background-position: 0 100%;">
				<div class="container py-4">
					<div class="row justify-content-md-center py-5 mt-3">
						<div class="col-md-12 col-lg-3 d-flex align-items-center justify-content-center justify-content-lg-start mb-5 mb-lg-0">
							<a href="index.html"><img src="/templates/vinass/img/logo.png" alt="Logo" class="img-fluid" style="max-width: 110px;"></a>
						</div>
