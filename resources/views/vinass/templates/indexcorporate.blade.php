				...
				<div class="container">
					...
					<div class="row align-items-center pt-4 appear-animation" data-appear-animation="fadeInLeftShorter">
						...
						<div class="col-md-8 pl-md-5">
							...
							<p class="text-4">There are so many styles you can combine that is possible to create almost any kind of layout based on VINASOFT Template, navigate in our preview and see the header variations, the colors, and the page content types that you will be able to use.</p>
					...
					<div class="row text-center pt-4 mt-5">
						<div class="col">
							<h2 class="word-rotator slide font-weight-bold text-8 mb-2">
								...
								<span> about VINASOFT Template...</span>
							</h2>
							<h4 class="text-primary lead tall text-4">30,000 CUSTOMERS IN 100 COUNTRIES USE VINASOFT TEMPLATE. MEET OUR CUSTOMERS.</h4>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-9 col-lg-9">
								<div class="call-to-action-content">
									<h2 class="font-weight-normal text-6 mb-0">VINASOFT is <strong>everything</strong> you need to create an <strong>awesome</strong> website!</h2>
				...
				<div class="container py-4">
					<div class="row justify-content-md-center py-5 mt-3">
						<div class="col-md-12 col-lg-3 d-flex align-items-center justify-content-center justify-content-lg-start mb-5 mb-lg-0">
							<a href="/"><img src="/templates/vinass/img/logo.png" alt="Logo" class="img-fluid" style="max-width: 110px;"></a>
						</div>
