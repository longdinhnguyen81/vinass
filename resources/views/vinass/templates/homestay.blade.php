...
<html data-style-switcher-options="{'changeLogo': false, 'borderRadius': 0, 'colorPrimary': '#333b48', 'colorSecondary': '#219cd2', 'colorTertiary': '#2bca6e', 'colorQuaternary': '#FFF'}">
	<head>
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/demos/demo-real-estate.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-real-estate.css">		<script src="/templates/vinass/master/style-switcher/style.switcher.localstorage.js"></script> 
	...
	<body class="loading-overlay-showing" data-loading-overlay>
										...
										<nav class="header-nav-top">
											<ul class="nav nav-pills">
												<li class="nav-item nav-item-borders py-2 d-none d-sm-inline-flex">
													<span class="pl-0"><i class="far fa-dot-circle text-4 text-color-light" style="top: 1px;"></i> 1234 Street Name, City Name</span>
												</li>
												<li class="nav-item nav-item-borders py-2">
													<a href="tel:123-456-7890"><i class="fab fa-whatsapp text-4 text-color-light" style="top: 0;"></i> 123-456-7890</a>
												</li>
												<li class="nav-item nav-item-borders py-2 d-none d-md-inline-flex">
													<a href="mailto:mail@domain.com"><i class="far fa-envelope text-4 text-color-light" style="top: 1px;"></i> mail@domain.com</a>
												</li>
											</ul>
										</nav>
									</div>
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 650, 'disableProgressBar': 'on', 'navigation': {'arrows': {'enable': true, 'left':{'container':'slider','h_align':'right','v_align':'center','h_offset':20,'v_offset':-80},'right':{'container':'slider','h_align':'right','v_align':'center','h_offset':20,'v_offset':80}}}}">
						...
						<ul>
							<li data-transition="fade">
								<img src="/templates/vinass/img/demos/real-estate/slides/slide-real-estate-1.jpg"  
									alt=""
							...
							<li data-transition="fade">
								<img src="/templates/vinass/img/demos/real-estate/slides/slide-real-estate-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat"
							...
							<li data-transition="fade">
								<img src="/templates/vinass/img/demos/real-estate/slides/slide-real-estate-3.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat"
		...
		<script src="/templates/vinass/vendor/rs-plugin/js/jquery.themepunch.tools.min.js"></script>		<script src="/templates/vinass/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

		<!-- Current Page Vendor and Views -->
		<script src="/templates/vinass/js/views/view.contact.js"></script>

		<!-- Demo -->
		<script src="/templates/vinass/js/demos/demo-real-estate.js"></script>
