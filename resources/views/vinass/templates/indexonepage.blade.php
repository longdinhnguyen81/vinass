	...
	<body class="one-page" data-target="#header" data-spy="scroll" data-offset="100">
		...
		<div class="body">
			...
			<div role="main" class="main" id="home">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1140, 'gridheight': 800, 'responsiveLevels': [4096,1200,992,500]}">
						<ul>
							<li class="slide-overlay" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-one-page-1-1.jpg"  
									alt=""
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-one-page-1-2.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-one-page-1-3.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-one-page-1-4.jpg" alt=""></div>
								...
								<div class="tp-caption tp-resizeme"
								    ...
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-one-page-1-5.jpg" alt=""></div>
								...
								<div class="tp-caption"
									...
									data-y="center" data-voffset="['2','2','2','15']"><img src="/templates/vinass/img/slides/slide-blue-line-big.png" alt=""></div>
							...
							<li class="slide-overlay" data-transition="fade">
								...
								<div class="tp-caption"
									...
									data-start="1000"
									data-transform_in="x:[-300%];opacity:0;s:500;"
									data-transform_idle="opacity:0.2;s:500;" style="z-index: 5;"><img src="/templates/vinass/img/slides/slide-title-border.png" alt=""></div>
				...
				<section id="clients" class="section section-background section-height-4 overlay overlay-show overlay-op-9 border-0 m-0" style="background-image: url(/templates/vinass/img/bg-one-page-1-1.jpg); background-size: cover; background-position: center;">
					<div class="container">
						<div class="row">
						...
						<div class="row text-center py-3 my-4">
							<div class="owl-carousel owl-theme carousel-center-active-item carousel-center-active-item-style-2 mb-0" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 5}, '992': {'items': 7}, '1200': {'items': 7}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': false}">
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-1.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-2.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-3.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-4.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-5.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-6.png" alt="">
								</div>
								<div>
									<img class="img-fluid" src="/templates/vinass/img/logos/logo-light-4.png" alt="">
								</div>
