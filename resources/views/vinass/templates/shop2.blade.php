...
<head>
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="/templates/vinass/assets2/css/bootstrap.min.css">

    <!-- Main CSS File -->
    <link rel="stylesheet" href="/templates/vinass/shop/css/style2.min.css">
</head>
<body>
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a ><img src="/templates/vinass/shop/images2/flags/en.png" alt="England flag">ENGLISH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a ><img src="/templates/vinass/shop/images2/flags/en.png" alt="England flag">ENGLISH</a></li>
                                    <li><a ><img src="/templates/vinass/shop/images2/flags/fr.png" alt="France flag">FRENCH</a></li>
                                </ul>
                            </div><!-- End .header-menu -->
                        </div><!-- End .header-dropown -->
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        <a href="/" class="logo">
                            <img src="/templates/vinass/img/logo-white.png" width="150px" height="50px" alt="Vinass Logo">
                        </a>
                    </div><!-- End .header-left -->
                                ...
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a  class="product-image">
                                                    <img src="/templates/vinass/shop/images2/products/cart/product-1.jpg" alt="product">
                                                </a>
                                                <a  class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a  class="product-image">
                                                    <img src="/templates/vinass/shop/images2/products/cart/product-2.jpg" alt="product">
                                                </a>
                                                <a  class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                        ...
                        <div class="col-lg-9">
                            <div class="home-slider owl-carousel owl-carousel-lazy">
                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="/templates/vinass/shop/images2/slider/slide-1.jpg"></div>
                                ...
                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="/templates/vinass/shop/images2/slider/slide-2.jpg"></div>
                                ...
                                <div class="home-slide">
                                    <div class="owl-lazy slide-bg" data-src="/templates/vinass/shop/images2/slider/slide-3.jpg"></div>
                                    <div class="home-slide-content">
                        ...
                        <div class="col-lg-3 order-lg-first">
                            <div class="side-custom-menu">
                                ...
                                <div class="side-menu-body">
                                    <ul>
                                        <li><a ><i class="icon-cat-shirt"></i>Fashion</a></li>
                                        <li><a ><i class="icon-cat-computer"></i>Electronics</a></li>
                                        <li><a ><i class="icon-cat-gift"></i>Gifts</a></li>
                                        <li><a ><i class="icon-cat-couch"></i>Home & Garden</a></li>
                                        <li><a ><i class="icon-cat-computer"></i>Music</a></li>
                                        <li><a ><i class="icon-cat-sport"></i>Sports</a></li>
                                    </ul>

                                    <a  class="btn btn-block btn-primary">HUGE SALE - <strong>70%</strong> Off</a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-1.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-2.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-3.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-3 -->
                        ...
                        <div class="col-lg-3 col-sm-6 order-lg-last">
                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-4.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-5.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-6.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-3 -->        
                        ...
                        <div class="col-lg-6">
                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-7.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-8.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images2/banners/banner-9.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-6 -->
                    </div><!-- End .row -->
                ...
                <div class="container">
                    ...
                    <div class="featured-products owl-carousel owl-theme owl-dots-top">
                        <div class="product">
                            <figure class="product-image-container">
                                <a  class="product-image">
                                    <img src="/templates/vinass/shop/images2/products/product-1.jpg" alt="product">
                                </a>
                        ...
                        <div class="product">
                            <figure class="product-image-container">
                                <a  class="product-image">
                                    <img src="/templates/vinass/shop/images2/products/product-2.jpg" alt="product">
                                </a>
                                <a  class="btn-quickview">Quick View</a>
                            </figure>
                            <div class="product-details">
                        ...
                        <div class="product">
                            <figure class="product-image-container">
                                <a  class="product-image">
                                    <img src="/templates/vinass/shop/images2/products/product-3.jpg" alt="product">
                                </a>
                                <a  class="btn-quickview">Quick View</a>
                            </figure>
                            <div class="product-details">
                        ...
                        <div class="product">
                            <figure class="product-image-container">
                                <a  class="product-image">
                                    <img src="/templates/vinass/shop/images2/products/product-4.jpg" alt="product">
                                </a>
                                <a  class="btn-quickview">Quick View</a>
                            </figure>
                            <div class="product-details">
                        ...
                        <div class="product">
                            <figure class="product-image-container">
                                <a  class="product-image">
                                    <img src="/templates/vinass/shop/images2/products/product-5.jpg" alt="product">
                                </a>
                                <a  class="btn-quickview">Quick View</a>
                            </figure>
                            <div class="product-details">
        ...
        <footer class="footer">
            ...
            <div class="container">
                <div class="footer-bottom">
                    ...
                    <img src="/templates/vinass/shop/images2/payments.png" alt="payment methods" class="footer-payments">
    ...
    <!-- Plugins JS File -->
    <script src="/templates/vinass/assets2/js/jquery.min.js"></script>
    <script src="/templates/vinass/assets2/js/bootstrap.bundle.min.js"></script>
    <script src="/templates/vinass/assets2/js/plugins.min.js"></script>

    <!-- Main JS File -->
    <script src="/templates/vinass/assets2/js/main.min.js"></script>
</body>
</html>