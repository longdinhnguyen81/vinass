...
<html>
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-19.css"> 
	...
	<body>
		...
		<div class="body">
													...
													<li class="dropdown">
														...
														<ul class="dropdown-menu">
															...
															<li class="dropdown-submenu">
																...
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-classic.html" data-thumb-preview="/templates/vinass/img/previews/preview-classic.jpg">Classic - Original</a></li>
																	<li><a class="dropdown-item" href="index-classic-color.html" data-thumb-preview="/templates/vinass/img/previews/preview-classic-color.jpg">Classic - Color</a></li>
																	<li><a class="dropdown-item" href="index-classic-light.html" data-thumb-preview="/templates/vinass/img/previews/preview-classic-light.jpg">Classic - Light</a></li>
																	<li><a class="dropdown-item" href="index-classic-video.html" data-thumb-preview="/templates/vinass/img/previews/preview-classic-video.jpg">Classic - Video</a></li>
																	<li><a class="dropdown-item" href="index-classic-video-light.html" data-thumb-preview="/templates/vinass/img/previews/preview-classic-video-light.jpg">Classic - Video - Light</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">Corporate <span class="tip tip-dark">hot</span></a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-corporate.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate.jpg">Corporate - Version 1</a></li>
																	<li><a class="dropdown-item" href="index-corporate-2.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-2.jpg">Corporate - Version 2</a></li>
																	<li><a class="dropdown-item" href="index-corporate-3.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-3.jpg">Corporate - Version 3</a></li>
																	<li><a class="dropdown-item" href="index-corporate-4.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-4.jpg">Corporate - Version 4</a></li>
																	<li><a class="dropdown-item" href="index-corporate-5.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-5.jpg">Corporate - Version 5</a></li>
																	<li><a class="dropdown-item" href="index-corporate-6.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-6.jpg">Corporate - Version 6</a></li>
																	<li><a class="dropdown-item" href="index-corporate-7.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-7.jpg">Corporate - Version 7</a></li>
																	<li><a class="dropdown-item" href="index-corporate-8.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-8.jpg">Corporate - Version 8</a></li>
																	<li><a class="dropdown-item" href="index-corporate-9.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-9.jpg">Corporate - Version 9</a></li>
																	<li><a class="dropdown-item" href="index-corporate-10.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-10.jpg">Corporate - Version 10</a></li>
																	<li><a class="dropdown-item" href="index-corporate-11.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-11.jpg">Corporate - Version 11</a></li>
																	<li><a class="dropdown-item" href="index-corporate-12.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-12.jpg">Corporate - Version 12</a></li>
																	<li><a class="dropdown-item" href="index-corporate-13.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-13.jpg">Corporate - Version 13</a></li>
																	<li><a class="dropdown-item" href="index-corporate-14.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-14.jpg">Corporate - Version 14</a></li>
																	<li><a class="dropdown-item" href="index-corporate-15.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-15.jpg">Corporate - Version 15</a></li>
																	<li><a class="dropdown-item" href="index-corporate-16.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-16.jpg">Corporate - Version 16</a></li>
																	<li><a class="dropdown-item" href="index-corporate-17.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-17.jpg">Corporate - Version 17</a></li>
																	<li><a class="dropdown-item" href="index-corporate-18.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-18.jpg">Corporate - Version 18</a></li>
																	<li><a class="dropdown-item" href="index-corporate-19.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-19.jpg">Corporate - Version 19</a></li>
																	<li><a class="dropdown-item" href="index-corporate-20.html" data-thumb-preview="/templates/vinass/img/previews/preview-corporate-20.jpg">Corporate - Version 20</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">Portfolio</a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-portfolio.html" data-thumb-preview="/templates/vinass/img/previews/preview-portfolio.jpg">Portfolio - Version 1</a></li>
																	<li><a class="dropdown-item" href="index-portfolio-2.html" data-thumb-preview="/templates/vinass/img/previews/preview-portfolio-2.jpg">Portfolio - Version 2</a></li>
																	<li><a class="dropdown-item" href="index-portfolio-3.html" data-thumb-preview="/templates/vinass/img/previews/preview-portfolio-3.jpg">Portfolio - Version 3</a></li>
																	<li><a class="dropdown-item" href="index-portfolio-4.html" data-thumb-preview="/templates/vinass/img/previews/preview-portfolio-4.jpg">Portfolio - Version 4</a></li>
																	<li><a class="dropdown-item" href="index-portfolio-5.html" data-thumb-preview="/templates/vinass/img/previews/preview-portfolio-5.jpg">Portfolio - Version 5</a></li>
																</ul>
															</li>		
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">Blog</a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-blog.html" data-thumb-preview="/templates/vinass/img/previews/preview-blog.jpg">Blog - Version 1</a></li>
																	<li><a class="dropdown-item" href="index-blog-2.html" data-thumb-preview="/templates/vinass/img/previews/preview-blog-2.jpg">Blog - Version 2</a></li>
																	<li><a class="dropdown-item" href="index-blog-3.html" data-thumb-preview="/templates/vinass/img/previews/preview-blog-3.jpg">Blog - Version 3</a></li>
																	<li><a class="dropdown-item" href="index-blog-4.html" data-thumb-preview="/templates/vinass/img/previews/preview-blog-4.jpg">Blog - Version 4</a></li>
																	<li><a class="dropdown-item" href="index-blog-5.html" data-thumb-preview="/templates/vinass/img/previews/preview-blog-5.jpg">Blog - Version 5</a></li>
																</ul>
															</li>
															<li class="dropdown-submenu">
																<a class="dropdown-item" href="#">One Page</a>
																<ul class="dropdown-menu">
																	<li><a class="dropdown-item" href="index-one-page.html" data-thumb-preview="/templates/vinass/img/previews/preview-one-page.jpg">One Page Original</a></li>
																</ul>
															</li>
														</ul>
													</li>
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1140, 'gridheight': 900, 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-2', 'left': {'h_align': 'center', 'v_align' : 'bottom', 'v_offset': 30, 'h_offset': 90}, 'right': {'h_align': 'center', 'v_align' : 'bottom', 'v_offset': 30, 'h_offset': 125}}, 'bullets': {'enable': false}}}">
						<ul>
							<li class="slide-overlay slide-overlay-primary slide-overlay-level-8" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-corporate-19-1.jpg"  
									alt=""
								...
								<div class="tp-caption font-weight-light text-center text-color-light"
									...
									data-lineheight="['29','29','29','40']">Trusted by over <strong>30,000</strong> satisfied users</div>
								...
								<h1 class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-lineheight="['55','55','90','95']">Welcome to Porto</h1>
								...
								<a class="tp-caption btn btn btn-dark font-weight-semibold text-color-light"
									...
									data-lineheight="['20','20','20','22']">GET STARTED NOW</a>
					...
					<div class="row text-center text-md-left mt-4">
						<div class="col-md-4 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							<div class="row text-center justify-content-center">
								<div class="col-4">
									<img class="img-fluid mb-4" src="/templates/vinass/img/icons/seo-grey.png" alt="">
								</div>
							</div>
							<div class="row text-center justify-content-center">
								<div class="col-lg-10">
									<h2 class="font-weight-bold text-5 line-height-5 mb-2">SEO Optimization</h2>
						...
						<div class="col-md-4 mb-4 mb-md-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
							<div class="row text-center justify-content-center">
								<div class="col-4">
									<img class="img-fluid mb-4" src="/templates/vinass/img/icons/marketing-grey.png" alt="">
								</div>
							</div>
							<div class="row text-center justify-content-center">
								<div class="col-lg-10">
									<h2 class="font-weight-bold text-5 line-height-5 mb-2">Pro Marketing Ads</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
							<div class="row text-center justify-content-center">
								<div class="col-4">
									<img class="img-fluid mb-4" src="/templates/vinass/img/icons/support-grey.png" alt="">
								</div>
							</div>
							<div class="row text-center justify-content-center">
								<div class="col-lg-10">
									<h2 class="font-weight-bold text-5 line-height-5 mb-2">Secure Support</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row align-items-center text-center text-md-left pt-4 pb-5 my-5">
						<div class="col-lg-7 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
							<h2 class="font-weight-bold text-6 line-height-1 ls-0 mb-4">Case of Success</h2>
						...
						<div class="col-lg-5 text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="700">
							<div class="row justify-content-center">
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-1.png" alt="">
								</div>
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-4.png" alt="">
								</div>
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-3.png" alt="">
								</div>
							</div>
							<div class="row justify-content-center py-md-3 my-md-4">
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-5.png" alt="">
								</div>
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-6.png" alt="">
								</div>
								<div class="col-9 col-md-4 px-0 mb-4 mb-md-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-7.png" alt="">
								</div>
							</div>
							<div class="row justify-content-center">
								<div class="col-9 col-md-4 px-0">
									<img class="img-fluid hover-effect-3" src="/templates/vinass/img/logos/logo-2.png" alt="">
								</div>
							</div>
						</div>
					</div>
				...
				<section class="parallax section section-text-light section-parallax section-angled section-angled-reverse overlay overlay-show overlay-op-8 my-0" data-plugin-parallax data-plugin-options="{'speed': 2.5}"data-image-src="/templates/vinass/img/generic/generic-corporate-19-1.jpg">
						...
						<div class="row align-items-center justify-content-center">
							<div class="col-md-6 pr-lg-4">
								<div class="row text-right justify-content-end">
									...
									<div class="col-lg-8">
										<img src="/templates/vinass/img/generic/generic-corporate-19-3.jpg" class="img-fluid position-relative appear-animation mb-2" data-appear-animation="expandIn" data-appear-animation-delay="600" alt="" />
									</div>
								</div>
							</div>
							<div class="col-md-6 pl-lg-4">
								<div class="row">
									<div class="col-lg-8">
										<img src="/templates/vinass/img/generic/generic-corporate-19-4.jpg" class="img-fluid position-relative appear-animation mb-2" data-appear-animation="expandIn" data-appear-animation-delay="600" alt="" />
									</div>
									<div class="col-lg-9 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
										<h4 class="text-3 text-color-primary font-weight-bold mb-2 mt-5">WORK WITH US</h4>
										<p class="text-4 line-height-9">Lorem ipsum dolor sit amet, consectetur adipiscing eli blandit massa enim. Nullam id varius nunc. Vivamus bibendum mex, et faucibus lacus venena bibendum mex.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container-fluid">
					<div class="row featured-boxes-full">
						<div class="col-lg-3 featured-box-full featured-box-full-light text-left">
							...
							<h4 class="text-4 font-weight-extra-bold text-color-dark mb-1 mt-2">Mobile Apps</h4>
							<p class="text-2 font-weight-semibold mb-0 pt-0 pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
						</div>
						<div class="col-lg-3 featured-box-full featured-box-full-light text-left">
							<i class="icon-layers icons text-8 text-primary mt-0 mb-3"></i>
							<h4 class="text-4 font-weight-extra-bold text-color-dark mb-1 mt-2">Creative Websites</h4>
							<p class="text-2 font-weight-semibold mb-0 pt-0 pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
						</div>
						<div class="col-lg-3 featured-box-full featured-box-full-light text-left">
							<i class="icon-magnifier icons text-8 text-primary mt-0 mb-3"></i>
							<h4 class="text-4 font-weight-extra-bold text-color-dark mb-1 mt-2">SEO Optimization</h4>
							<p class="text-2 font-weight-semibold mb-0 pt-0 pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
						</div>
						<div class="col-lg-3 featured-box-full featured-box-full-light text-left">
							<i class="icon-screen-desktop icons text-8 text-primary mt-0 mb-3"></i>
							<h4 class="text-4 font-weight-extra-bold text-color-dark mb-1 mt-2">Brand Solutions</h4>
							<p class="text-2 font-weight-semibold mb-0 pt-0 pb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-6 match-height p-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
							<img src="/templates/vinass/img/generic/generic-corporate-19-2.jpg" class="img-fluid w-100" alt="" />
						</div>
						<div class="col-lg-6 p-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							<section class="section section-height-5 section-dark match-height border-top-0 my-0">
								<div class="row text-center justify-content-center align-items-center h-100 mx-0">
									<div class="col-lg-8">
										<h3 class="text-transform-none text-8 line-height-2 mb-3">Porto is <strong>everything</strong> you need to create an <strong>awesome</strong> website!</h3>
										<p class="text-5 font-weight-light mb-4">The best HTML template for your new website.</p>
										<a href="#" class="btn btn-light btn-xl font-weight-bold rounded-0 text-2 text-color-dark mb-3">LEARN MORE</a>
									</div>
								</div>
							</section>
						</div>
