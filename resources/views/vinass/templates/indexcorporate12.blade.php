...
<html class="side-header">
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-12.css"> 
	...
	<body>
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 550, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrow-dark' }, 'bullets': {'enable': true, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li data-transition="fade" class="slide-overlay slide-overlay-level-8">
								<img src="/templates/vinass/img/slides/slide-corporate-12-1.jpg"  
									alt=""
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-lineheight="['55','55','55','95']">WELCOME TO PORTO</div>
								...
								<div class="tp-caption font-weight-light text-center ws-normal"
									...
									style="color: #e0e0e0;">Trusted by over <strong class="text-color-light">30,000</strong> satisfied users, Porto is a huge sucess in the of one of the world's largest MarketPlace.</div>
							...
							<li class="slide-overlay" data-transition="fade">
								<img src="/templates/vinass/img/blank.gif"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-y="center" data-voffset="['-60','-60','-60','-85']"
									data-fontsize="['55','60','60','100']"
									data-lineheight="['55','55','55','95']" style="z-index: 5;">HELLO &amp; WELCOME</div>
								...
								<div class="tp-caption font-weight-light text-center ws-normal"
									...
									data-fontsize="['20','20','20','50']"
									data-lineheight="['29','29','29','60']"
									style="color: #e0e0e0; z-index: 5;">Porto is trusted by over <strong class="text-color-light">30,000</strong> satisfied users. Learn more about us and our amazing projects.</div>
				
								<a class="tp-caption btn btn-dark font-weight-semibold rounded-0"
									data-frames='[{"delay":3500,"speed":2000,"frame":"0","from":"opacity:0;y:50%;","to":"o:1;y:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
									href="#"
									data-x="center" data-hoffset="0"
									data-y="center" data-voffset="['100','100','100','275']"
									...
									data-paddingright="['45','45','45','110']"
									data-paddingbottom="['20','20','20','45']"				 
									data-paddingleft="['45','45','45','110']" style="z-index: 5;">GET STARTED NOW!</a>

								<div class="tp-dottedoverlay tp-opacity-overlay-light bg-color-primary opacity-8"></div>
							</li>
						</ul>
					</div>
				</div>
							...
							<a href="portfolio-single-wide-slider.html">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="/templates/vinass/img/projects/project-39.jpg" class="img-fluid" alt="">
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
							<a href="portfolio-single-wide-slider.html">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="/templates/vinass/img/projects/project-40.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0 appear-animation" data-appear-animation="fadeIn">
							<a href="portfolio-single-wide-slider.html">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="/templates/vinass/img/projects/project-41.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
							<a href="portfolio-single-wide-slider.html">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="/templates/vinass/img/projects/project-42.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
					...
					<div class="isotope-item">
						<div class="image-gallery-item mb-0 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400">
							<a href="portfolio-single-wide-slider.html">
								<span class="thumb-info thumb-info-centered-info thumb-info-no-borders">
									<span class="thumb-info-wrapper">
										<img src="/templates/vinass/img/projects/project-43.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title">
											<span class="thumb-info-inner">Project Title</span>
											<span class="thumb-info-type">Project Type</span>
										</span>
				...
				<div class="container-fluid bg-color-dark">
					<div class="row">
						<div class="col text-center p-0">
							<a class="btn btn-block text-3 py-4" href="#">LOAD MORE...</a>
						</div>
					</div>
				</div>
					...
					<div class="row justify-content-center">
						...
						<div class="col-md-7 col-lg-4 mb-5 mb-lg-0">
							<div class="circular-bar mb-lg-5 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
								<div class="circular-bar-chart" data-percent="25" data-plugin-options="{'barColor': '#62AC6E'}">
						...
						<div class="col-md-7 col-lg-4 mb-5 mb-lg-0">
							<div class="circular-bar mb-lg-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400">
								<div class="circular-bar-chart" data-percent="50" data-plugin-options="{'barColor': '#62AC6E'}">
						...
						<div class="col-md-7 col-lg-4">
							<div class="circular-bar mb-lg-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
								<div class="circular-bar-chart" data-percent="100" data-plugin-options="{'barColor': '#62AC6E'}">
									...
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark mb-0">
												...
												<blockquote>
													<p class="text-color-dark text-5 line-height-5 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eget tortor porta, tempus turpis quis, tempor odio. Etiam hendrerit magna et mollis accumsan. Integer faucibus at erat a consectetur. Mauris dapibus blandit.</p>
												</blockquote>
												<div class="testimonial-author">
													<p><strong class="opacity-9 font-weight-extra-bold text-2">- John Doe. Okler</strong></p>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="container appear-animation" data-appear-animation="fadeIn">
						<div class="row">
							<div class="col text-center">
								<h2 class="text-color-light text-8 line-height-1 ls-0 mb-4">Porto is <strong>everthing</strong> you need to create an <strong>awesome</strong> website!</h2>
							</div>
						</div>
						<div class="row mt-2">
							<div class="col text-center">
								<a href="#" class="btn btn-primary font-weight-semibold rounded-0 text-3 px-5 btn-py-3">GET STARTED NOW!</a>
							</div>
						</div>
					</div>
				</section>
			...
			<footer id="footer" class="footer-top-border bg-color-light-scale-1 mt-0">
				<div class="footer-copyright bg-color-light-scale-1">
					<div class="container-fluid py-2">
						<div class="row py-4">
							<div class="col-md-6">
								<p class="d-lg-none"><strong>PORTO TEMPLATE</strong> - © Copyright 2019 - All Rights Reserved.</p>
							</div>
							<div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-end">
								<nav id="sub-menu">
									<ul>
										<li><i class="fas fa-angle-right"></i><a href="page-faq.html" class="ml-1 text-decoration-none text-color-primary"> FAQ's</a></li>
										<li><i class="fas fa-angle-right"></i><a href="sitemap.html" class="ml-1 text-decoration-none text-color-primary"> Sitemap</a></li>
										<li><i class="fas fa-angle-right"></i><a href="contact-us.html" class="ml-1 text-decoration-none text-color-primary"> Contact Us</a></li>
									</ul>
								</nav>
							</div>
						</div>
		...
		<script src="/templates/vinass/vendor/nanoscroller/jquery.nanoscroller.min.js"></script>
