...
<html class="side-header-hamburguer-sidebar side-header-hamburguer-sidebar-right side-header-hamburguer-sidebar-push side-header-hide side-header-right-no-reverse">
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-13.css"> 
		...
		<div class="body">
					...
					<div class="container-fluid">
						<div class="row align-items-center">
							<div class="col-9">
								<div class="py-4">
									<a href="index.html">
										<img alt="Porto" width="82" height="40" data-change-src="/templates/vinass/img/logo.png" src="/templates/vinass/img/logo.png">
									</a>
								</div>
							</div>
					...
					<div class="header-container container d-flex h-100">
						<div class="header-column flex-column justify-content-center h-100">
									...
									<div class="header-nav-main header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-4 header-nav-main-sub-effect-1">
										<nav class="collapse">
											<ul class="nav nav-pills" id="mainNav">
												...
												<li class="dropdown d-none dropdown-mega">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu">
														...
														<li class="dropdown-submenu">
															<a class="dropdown-item" href="#">Admin Extension <span class="tip tip-dark">hot</span></a>
															<ul class="dropdown-menu">
																<li class="back-button d-none d-lg-block">
																	<a class="dropdown-item">
																		Back
							...
							<div class="header-row justify-content-end pb-3">
								...
								<p class="text-1 pt-3">© 2018 PORTO. All rights reserved</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-big' }, 'bullets': {'enable': false, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li class="slide-overlay slide-overlay-gradient slide-overlay-level-9" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-corporate-13-1.jpg"  
									alt=""
								...
								<h1 class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">THIS IS PORTO TEMPLATE</h1>
								...
								<div class="tp-caption d-none d-md-block"
									...
									data-y="center" data-voffset="['-92','-92','-92','-100']"><img src="/templates/vinass/img/slides/slide-white-line.png" alt=""></div>
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-letterspacing="0">HELLO & WELCOME</div>
								...
								<div class="tp-caption font-weight-light text-color-light text-center ws-normal"
									...
									data-lineheight="['29','29','29','60']">Porto is a huge sucess in the one of the world's largest MarketPlace.</div>
								...
								<a class="tp-caption btn btn-dark font-weight-semibold"
									...
									data-paddingleft="['33','33','33','80']">GET STARTED NOW!</a>
						...
						<div class="col-lg-10">
							...
							<div class="tabs tabs-bottom tabs-center tabs-simple">
								<ul class="nav nav-tabs mb-3">
									<li class="nav-item active appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons1" data-toggle="tab">
											...
											<h4 class="font-weight-bold text-color-dark text-3 mb-0 pb-0 mt-2">Customer Support</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInLeftShorter">
										<a class="nav-link" href="#tabsNavigationSimpleIcons2" data-toggle="tab">
											...
											<h4 class="font-weight-bold text-color-dark text-3 mb-0 pb-0 mt-2">HTML5 / CSS3 / JS</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter">
										<a class="nav-link" href="#tabsNavigationSimpleIcons3" data-toggle="tab">
											...
											<h4 class="font-weight-bold text-color-dark text-3 mb-0 pb-0 mt-2">500+ Google Fonts</h4>
										</a>
									</li>
									<li class="nav-item appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
										<a class="nav-link" href="#tabsNavigationSimpleIcons4" data-toggle="tab">
											...
											<h4 class="font-weight-bold text-color-dark text-3 mb-0 pb-0 mt-2">Colors</h4>
										</a>
									</li>
								</ul>
								...
								<div class="tab-content appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
									<div class="tab-pane active" id="tabsNavigationSimpleIcons1">
										<div class="text-center">
											<p class="lead mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut feugiat urna arcu, vel molestie nunc commodo non. Nullam vestibulum odio vitae fermentum rutru , vel molestie nunc commodo non. Nullam vestibulum odio vitae fermentum rutrum , vel molestie nunc commodo non.</p>
									...
									<div class="tab-pane" id="tabsNavigationSimpleIcons2">
										<div class="text-center">
											<p class="lead mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eu nunc in justo hendrerit vulputate in sed nibh. Ut tristique metus eu ipsum egestas, vel malesuada odio semper. Aenean quis ultrices nisl. Ut sagittis tellus ac aliquet rhoncus. Aliquam.</p>
						...
						<div class="row align-items-center text-center text-md-left">
							...
							<div class="col-md-6 col-lg-5 offset-lg-1 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
								<div class="owl-carousel owl-theme nav-style-1 stage-margin mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 1}, '1200': {'items': 1}}, 'margin': 25, 'loop': true, 'nav': true, 'dots': false, 'stagePadding': 40}">
									<div class="p-4">
										<img class="img-fluid box-shadow-3 mb-3" src="/templates/vinass/img/gallery/gallery-6.jpg" alt="" />
									</div>
									<div class="p-4">
										<img class="img-fluid box-shadow-3 mb-3" src="/templates/vinass/img/gallery/gallery-7.jpg" alt="" />
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row py-5 my-5">
						...
						<div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark testimonial-remove-right-quote mb-0">
								<div class="testimonial-author">
									<img src="/templates/vinass/img/clients/client-2.jpg" class="img-fluid rounded-circle mb-0" alt="">
								</div>
								<blockquote>
								...
								<div class="testimonial-author">
									<p><strong class="font-weight-extra-bold text-3 mb-1">Jessica Doe</strong><span>Okler</span></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="200">
					<div id="googlemaps" class="google-map my-0" style="min-height: 550px;"></div>
				</div>
				...
				<div class="container">
					<div class="row py-5 justify-content-center">
						...
						<div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center text-lg-right">
							...
							<p class="text-8 text-color-light font-weight-bold pb-1 mb-0">(800) 123-4567</p>
						...
						<div class="row py-4">
							<div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
								<a href="index.html" class="logo pr-0 pr-lg-3">
									<img alt="Porto Website Template" src="/templates/vinass/img/logo.png" height="33">
								</a>
							</div>
		...
		<script>
			...
			*/
			...
			var mapMarkers = [{
				...
				icon: {
					image: "/templates/vinass/img/pin.png",
					iconsize: [26, 46],
					iconanchor: [12, 46]
				},
				popup: true
