<!DOCTYPE html>
<html class="gap-outside side-header-hamburguer-sidebar side-header-hamburguer-sidebar-right side-header-above side-header-right-no-reverse">
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-18.css"> 
	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'addOnTypewriter': { 'enable': true }, 'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': [1410,1110,930,690], 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1422,1182,974], 'navigation' : {'arrows': { 'enable': true, 'style': 'arrows-style-1 arrows-primary' }, 'bullets': {'enable': false}}}">
						<ul>
							<li class="slide-overlay slide-overlay-level-8" data-transition="fade">
								...
								<div class="tp-caption font-weight-extra-bold text-color-light text-center ws-normal"
									data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:1.5;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
									data-x="center"
									data-y="center" data-voffset="['-60','-60','-60','-85']"
									data-width="['350','350','350','750']"
									data-fontsize="['42','42','42','75']"
									data-lineheight="['55','55','55','95']"
									data-letterspacing="0">Welcome to our amazing office</div>
								...
								<div class="tp-caption font-weight-light text-color-light text-center ws-normal"
									...
									data-x="center"
									data-y="center" data-voffset="['25','25','25','70']"
									data-width="['400','400','400','600']"
									data-fontsize="['18','18','18','50']"
									data-lineheight="['29','29','29','75']">Porto is a huge success, learn more about us.</div>

								<a class="tp-caption btn btn btn-gradient font-weight-semibold text-color-light"
									...
									href="#main"
									data-x="center"
									data-y="center" data-voffset="['90','90','90','225']"
									data-whitespace="nowrap"	
									data-fontsize="['12','12','12','30']"	
									data-paddingtop="['18','18','18','40']"
									data-paddingright="['35','35','35','80']"
									data-paddingbottom="['18','18','18','40']"			 
									data-paddingleft="['35','35','35','80']"
									data-lineheight="['20','20','20','22']">GET STARTED NOW <i class="fas fa-arrow-right ml-3"></i></a>

							</li>
							<li class="slide-overlay slide-overlay-level-8" data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-corporate-18-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="tp-caption font-weight-extra-bold text-color-light text-center ws-normal"
									...
									data-fontsize="['42','42','42','75']"
									data-lineheight="['55','55','55','95']"
									data-letterspacing="0">Drone Video Aereal Filming</div>

								<div class="tp-caption font-weight-light text-color-light text-center ws-normal"
									data-frames='[{"from":"opacity:0;","speed":300,"to":"o:0.8;","delay":2000,"split":"chars","splitdelay":0.04,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
									data-x="center"
									data-y="center" data-voffset="['25','25','25','50']"
									data-width="['200','200','200','500']"
									data-fontsize="['18','18','18','50']"
									data-lineheight="['29','29','29','50']">learn more about us.</div>
								...
								<a class="tp-caption btn btn btn-gradient font-weight-semibold text-color-light"
									...
									href="#main"
									data-x="center"
									data-y="center" data-voffset="['90','90','90','200']"
									data-whitespace="nowrap"	
									data-fontsize="['12','12','12','30']"	
									data-paddingtop="['18','18','18','40']"
									data-paddingright="['35','35','35','80']"
											...
											<div class="feature-box align-items-center">
												...
												<div class="feature-box-info">
													<p class="mb-0 text-color-dark font-weight-bold negative-ls-1">
														We are sure you will enjoy work with us, watch our video.
														<span class="text-color-dark opacity-5 ls-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
													</p>
												</div>
											</div>
										</a>
				...
				<div class="container container-lg py-5 my-5">
					<div class="row text-center text-lg-left">
						...
						<div class="col-md-6 col-lg-3 text-center px-2 mt-3 mt-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
							<img src="/templates/vinass/img/projects/project-44.jpg" class="img-fluid" alt=""/>
						</div>
								...
								<div class="row process my-5">
									<div class="process-step col-lg-4 mb-5 mb-lg-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
										...
										<div class="process-step-content px-4">
											<h4 class="mb-1 text-5 font-weight-bold mb-2">First Step</h4>
									...
									<div class="process-step col-lg-4 mb-5 mb-lg-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
										...
										<div class="process-step-content px-4">
											<h4 class="mb-1 text-5 font-weight-bold mb-2">Second Step</h4>
											<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur rhoncus nulla dui, in dapibus magna aliquam et.</p>
										</div>
									</div>
									<div class="process-step col-lg-4 mb-5 mb-lg-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
										...
										<div class="process-step-content px-4">
											<h4 class="mb-1 text-5 font-weight-bold mb-2">Third Step</h4>
											<p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur rhoncus nulla dui, in dapibus magna aliquam et.</p>
										</div>
									</div>
								</div>
				...
				<section class="parallax section section-text-light section-parallax section-center overlay overlay-show overlay-op-8 my-0" data-plugin-parallax data-plugin-options="{'speed': 2.0}"data-image-src="/templates/vinass/img/parallax/parallax-corporate-18.jpg">
								...
								<div class="col-md-6">
									<div class="featured-box featured-box-primary featured-box-effect-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
										<div class="box-content px-4">
											...
											<p class="px-3 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
										</div>
									</div>
								</div>
								<div class="col-md-6">
		...
		<script type="text/javascript" src="/templates/vinass/vendor/rs-plugin/revolution-addons/typewriter/js/revolution.addon.typewriter.min.js"></script>
