...
<html>
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-8.css"> 
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 530, 'responsiveLevels': [4096,1200,992,500], 'navigation' : {'arrows': { 'enable': false }, 'bullets': {'enable': false, 'style': 'bullets-style-1 bullets-color-primary', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 70, 'h_offset': 0}}}">
						<ul>
							<li data-transition="fade">
								<img src="/templates/vinass/img/slides/slide-bg-light.jpg"  
									alt=""
								...
								<div class="tp-caption tp-resizeme d-none d-sm-block"
								    ...
								    data-type="image" 
								    data-x="right" data-hoffset="['0','0','-200','-200']"
								    data-y="top"
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-corporate-8-1-2.jpg" alt=""></div>
				
								<div class="tp-caption tp-resizeme d-none d-sm-block"
									data-frames='[{"delay":1500,"speed":2000,"frame":"0","from":"opacity:0;x:-100%;","to":"o:1;x:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"Power3.easeInOut"}]'
								    data-type="image" 
								    data-x="left" data-hoffset="['0','0','-200','-200']"
								    data-y="center"
								    data-width="['auto']"
								    data-height="['auto']"
								    data-basealign="slide"><img src="/templates/vinass/img/slides/slide-corporate-8-1-1.jpg" alt=""></div>
				
								<div class="tp-caption"
									data-x="center" data-hoffset="['-130','-130','-130','-205']"
									data-y="center" data-voffset="['-100','-100','-100','-125']"
									data-start="1000"
									data-transform_in="x:[-300%];opacity:0;s:500;"
									data-transform_idle="opacity:0.8;s:500;"><img src="/templates/vinass/img/slides/slide-title-border-light.png" alt=""></div>
								...
								<div class="tp-caption text-color-dark font-weight-semibold"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">PORTO TEMPLATE</div>
								...
								<h1 class="tp-caption font-weight-extra-bold text-color-dark negative-ls-2"
									...
									data-lineheight="['55','55','55','95']">INCREDIBLE DESIGNS</h1>
								...
								<a class="tp-caption btn btn-primary font-weight-bold"
									...
									data-y="center" data-voffset="['70','70','70','135']"
						...
						<div class="col-lg-5">
							<div class="row mt-5 mt-lg-0">
								<div class="col-md-8 col-lg-6 text-center text-lg-left mx-auto">
									<img class="img-fluid m-3 my-0 mt-lg-5 pt-lg-5 appear-animation" src="/templates/vinass/img/office/our-office-4.jpg" alt="Office" data-appear-animation="expandIn" data-appear-animation-delay="200">
								</div>
								<div class="col-md-8 col-lg-6 pl-lg-0 text-center text-lg-left mx-auto">
									<img class="img-fluid m-3 my-0 appear-animation" src="/templates/vinass/img/office/our-office-5.jpg" alt="Office" data-appear-animation="expandIn" data-appear-animation-delay="400">
									<img class="img-fluid m-3 my-0 appear-animation" src="/templates/vinass/img/office/our-office-7.jpg" alt="Office" data-appear-animation="expandIn" data-appear-animation-delay="200">
								</div>
							</div>
						</div>
					</div>
									...
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark mb-0">
												...
												<blockquote>
													<p class="text-color-dark mb-0">Your time is limited, so don’t waste it living someone else’s life. Don’t be trapped by dogma - which is living with the results of other people’s thinking. Don’t let the noise of others’ opinions drown out your own inner voice.</p>
												</blockquote>
												<div class="testimonial-author">
									...
									<div>
										<div class="col">
											<div class="testimonial testimonial-style-2 testimonial-with-quotes testimonial-quotes-dark mb-0">
												...
												<blockquote>
													<p class="text-color-dark mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget risus porta, tincidunt turpis at, interdum tortor. Suspendisse potenti. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
												</blockquote>
												<div class="testimonial-author">
													<p><strong class="opacity-9 font-weight-extra-bold text-2">-John Smith. Okler</strong></p>
												</div>
				...
				<div class="container">
					...
					<div class="row py-5 my-4">
						...
						<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
							...
							<ul class="list-unstyled mb-0">
								<li class="media mb-3 pb-1">
									<a href="#">
										<img class="mr-3 rounded-circle" src="/templates/vinass/img/office/our-office-4-square.jpg" alt="" style="max-width: 70px;">
									</a>
								...
								<li class="media">
									<a href="#">
										<img class="mr-3 rounded-circle" src="/templates/vinass/img/office/our-office-5-square.jpg" alt="" style="max-width: 70px;">
									</a>
									<div class="media-body">
										<a href="#">
											<p class="text-3 text-color-light opacity-8 mb-1">Lorem ipsum dolor sit, consectetur adipiscing elit.</p>
						...
						<div class="col-md-6 col-lg-2">
							...
							<p>
								<a href="#"><span class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">DESIGN</span></a>
						...
						<div class="row py-4">
							<div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
								<a href="index.html" class="logo pr-0 pr-lg-3">
									<img alt="Porto Website Template" src="/templates/vinass/img/logo.png" class="opacity-5" height="33">
								</a>
							</div>
