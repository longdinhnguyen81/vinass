...
<html>
	<head>
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="/templates/vinass/css/skins/skin-corporate-9.css"> 
...
<body>
	...
	<div class="body">
		...
		<div role="main" class="main">
				...
				<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'responsiveLevels': [4096,1200,992,500], 'navigation': {'arrows': {'enable': true, 'style': 'arrows-style-1 arrows-big arrows-dark'}}}">
					...
					<ul>
						<li data-transition="fade">
							<img src="/templates/vinass/img/slides/slide-corporate-9-1.jpg"  
								alt=""
							...
							<div class="tp-caption d-none d-md-block"
								...
								data-x="center" data-hoffset="['90','90','90','135']"
								data-y="center" data-voffset="['-33','-33','-33','-55']"><img src="/templates/vinass/img/slides/slide-dark-line.png" alt=""></div>
							...
							<h1 class="tp-caption font-weight-extra-bold text-color-dark negative-ls-2"
								...
								data-lineheight="['55','55','55','95']">PORTO TEMPLATE</h1>
						...
						<li data-transition="fade">
							<img src="/templates/vinass/img/slides/slide-corporate-9-2.jpg"  
								alt=""
								data-bgposition="center center" 
								data-bgfit="cover" 
								data-bgrepeat="no-repeat" 
							...
							<div class="tp-caption font-weight-extra-bold text-color-dark negative-ls-2"
								...
								data-y="center"
								data-fontsize="['50','50','50','90']"
								data-lineheight="['55','55','55','95']">AMAZING DESIGN</div>
							...
							<div class="tp-caption font-weight-light text-color-dark opacity-8"
								...
								data-fontsize="['18','18','18','50']"
								data-lineheight="['20','20','20','55']"
								style="color: #b5b5b5;">The best choice for your new website</div>
			...
			<section class="parallax section section-height-3 section-parallax m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="/templates/vinass/img/parallax/parallax-corporate-9-1.jpg">
				<div class="container">
								...
								<div class="row">
									<div class="col">
										<a href="blog-post.html" class="text-decoration-none">
											<img src="/templates/vinass/img/blog/blog-corporate-9-1.jpg" class="img-fluid hover-effect-2 mb-3" alt="" />
										</a>
									</div>
								</div>
								<div class="row">
						...
						<div class="col-sm-8 col-md-4 mb-4 mb-md-0">
							<article>
								<div class="row">
									<div class="col">
										<a href="blog-post.html" class="text-decoration-none">
											<img src="/templates/vinass/img/blog/blog-corporate-9-2.jpg" class="img-fluid hover-effect-2 mb-3" alt="" />
										</a>
									</div>
								</div>
								<div class="row">
						...
						<div class="col-sm-8 col-md-4">
							<article>
								<div class="row">
									<div class="col">
										<a href="blog-post.html" class="text-decoration-none">
											<img src="/templates/vinass/img/blog/blog-corporate-9-3.jpg" class="img-fluid hover-effect-2 mb-3" alt="" />
										</a>
									</div>
								</div>
								<div class="row">
