...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="/templates/vinass/shop/css/style7.min.css">
</head>
<body>
                ...
                <div class="home-slider-container">
                    <div class="home-slider owl-carousel owl-theme owl-theme-light">
                        <div class="home-slide">
                            <div class="slide-bg owl-lazy" data-src="/templates/vinass/shop/images7/slider/slide-1.jpg"></div><!-- End .slide-bg -->
                        ...
                        <div class="home-slide home-slide-left">
                            <div class="slide-bg owl-lazy" data-src="/templates/vinass/shop/images7/slider/slide-2.jpg"></div><!-- End .slide-bg -->
    ...
    <!-- Plugins JS File -->
    <script src="/templates/vinass/assets7/js/jquery.min.js"></script>
    <script src="/templates/vinass/assets7/js/bootstrap.bundle.min.js"></script>
    <script src="/templates/vinass/assets7/js/plugins.min.js"></script>

    <!-- Main JS File -->
    <script src="/templates/vinass/assets7/js/main.min.js"></script>
</body>
</html>