...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="/templates/vinass/shop/css/style5.min.css">
</head>
<body>
    <div class="page-wrapper">
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a href="#"><img src="/templates/vinass/shop/images5/flags/en.png" alt="England flag">ENGLISH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#"><img src="/templates/vinass/shop/images5/flags/en.png" alt="England flag">ENGLISH</a></li>
                                    <li><a href="#"><img src="/templates/vinass/shop/images5/flags/fr.png" alt="France flag">FRENCH</a></li>
                                </ul>
                            </div><!-- End .header-menu -->
                        </div><!-- End .header-dropown -->
                                ...
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="#" class="product-image">
                                                    <img src="/templates/vinass/shop/images5/products/cart/product-1.jpg" alt="product">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="#" class="product-image">
                                                    <img src="/templates/vinass/shop/images5/products/cart/product-2.jpg" alt="product">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
        ...
        <main class="main">
            <div class="home-slider-container">
                <div class="home-slider owl-carousel">
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="/templates/vinass/shop/images5/slider/slide-1.jpg"></div><!-- End .slide-bg -->
                    ...
                    <div class="home-slide">
                        <div class="slide-bg owl-lazy"  data-src="/templates/vinass/shop/images5/slider/slide-2.jpg"></div><!-- End .slide-bg -->
                        <div class="home-slide-content container">
                            <h4>Amazing</h4>
                            <h1>Micro Drones</h1>
            ...
            <div class="promo-section" style="background-image: url(/templates/vinass/shop/images5/promo-bg.jpg)">
                <div class="container">
                ...
                <div class="container">
                    <div class="partners-carousel owl-carousel owl-theme">
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/1.png" alt="logo">
                        </a>
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/2.png" alt="logo">
                        </a>
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/3.png" alt="logo">
                        </a>
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/4.png" alt="logo">
                        </a>
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/5.png" alt="logo">
                        </a>
                        <a href="#" class="partner">
                            <img src="/templates/vinass/shop/images5/logos/2.png" alt="logo">
                        </a>
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="product-column">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-1.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-2.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-3.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="product-column">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-4.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-5.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-6.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                    ...
                    <div class="col-6 col-lg-3">
                        <div class="product-column">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-7.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-8.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
                            ...
                            <div class="product product-sm">
                                <figure class="product-image-container">
                                    <a href="#" class="product-image">
                                        <img src="/templates/vinass/shop/images5/products/small/product-9.jpg" alt="product">
                                    </a>
                                </figure>
                                <div class="product-details">
                                    <h2 class="product-title">
    ...
    <!-- Plugins JS File -->
    <script src="/templates/vinass/assets5/js/jquery.min.js"></script>
    <script src="/templates/vinass/assets5/js/bootstrap.bundle.min.js"></script>
    <script src="/templates/vinass/assets5/js/plugins.min.js"></script>

    <!-- Main JS File -->
    <script src="/templates/vinass/assets5/js/main.min.js"></script>
</body>
</html>