...
<head>
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="/templates/vinass/assets4/css/bootstrap.min.css">

    <!-- Main CSS File -->
    <link rel="stylesheet" href="/templates/vinass/shop/css/style4.min.css">
</head>
<body>
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a ><img src="/templates/vinass/shop/images4/flags/en.png" alt="England flag">ENGLISH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a ><img src="/templates/vinass/shop/images4/flags/en.png" alt="England flag">ENGLISH</a></li>
                                    <li><a ><img src="/templates/vinass/shop/images4/flags/fr.png" alt="France flag">FRENCH</a></li>
                                </ul>
                            </div><!-- End .header-menu -->
                        </div><!-- End .header-dropown -->
            ...
            <div class="header-middle">
                <div class="container">
                    <div class="header-left">
                        <a  href="/" class="logo">
                            <img src="/templates/vinass/img/logo-black.png" width="150px" height="50px" alt="Vinass Logo">
                        </a>
                    </div><!-- End .header-left -->
                                ...
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a  class="product-image">
                                                    <img src="/templates/vinass/shop/images4/products/cart/product-1.jpg" alt="product">
                                                </a>
                                                <a  class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a  class="product-image">
                                                    <img src="/templates/vinass/shop/images4/products/cart/product-2.jpg" alt="product">
                                                </a>
                                                <a  class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="home-slider owl-carousel owl-carousel-lazy">
                                <div class="home-slide">
                                    <img class="owl-lazy" src="/templates/vinass/shop/images4/lazy.png" data-src="/templates/vinass/shop/images4/slider/slide-1.jpg" alt="slider image">
                                ...
                                <div class="home-slide">
                                    <img class="owl-lazy" src="/templates/vinass/shop/images4/lazy.png" data-src="/templates/vinass/shop/images4/slider/slide-2.jpg" alt="slider image">
                                    <div class="home-slide-content">
                                        <h1>up to 50% off</h1>
                        ...
                        <div class="col-lg-4 top-banners">
                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images4/banners/banner-1.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images4/banners/banner-2.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->

                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images4/banners/banner-3.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .col-lg-4 -->
                    </div><!-- End .row -->
                ...
                <div class="row">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-1.jpg" alt="product">
                                                    </a>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-2.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-3.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-4.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-9.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                    <span class="product-label label-sale">-20%</span>
                                                    <span class="product-label label-hot">New</span>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-8.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                </figure>
                                                <div class="product-details">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-5.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                </figure>
                                                <div class="product-details">
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-6.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                    <span class="product-label label-sale">-20%</span>
                                                    <span class="product-label label-hot">New</span>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="product">
                                                <figure class="product-image-container">
                                                    <a  class="product-image">
                                                        <img src="/templates/vinass/shop/images4/products/product-7.jpg" alt="product">
                                                    </a>
                                                    <a  class="btn-quickview">Quick View</a>
                                                </figure>
                                                <div class="product-details">
                        ...
                        <div class="banners-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="banner banner-image">
                                        <a >
                                            <img src="/templates/vinass/shop/images4/banners/banner-4.jpg" alt="banner">
                                        </a>
                                    </div><!-- End .banner -->

                                    <div class="banner banner-image">
                                        <a >
                                            <img src="/templates/vinass/shop/images4/banners/banner-5.jpg" alt="banner">
                                        </a>
                                    </div><!-- End .banner -->
                                </div><!-- End .col-md-4 -->
                                ...
                                <div class="col-md-8">
                                    <div class="banner banner-image">
                                        <a >
                                            <img src="/templates/vinass/shop/images4/banners/banner-6.jpg" alt="banner">
                                        </a>
                                    </div><!-- End .banner -->
                                </div><!-- End .col-md-4 -->
                            </div><!-- End .row -->
                    ...
                    <aside class="sidebar-home col-lg-3">
                        ...
                        <div class="widget">
                            <div class="banner banner-image">
                                <a >
                                    <img src="/templates/vinass/shop/images4/banners/banner-sidebar-2.jpg" alt="banner">
                                </a>
                            </div><!-- End .banner -->
                        </div><!-- End .widget -->
                        ...
                        <div class="widget">
                            ...
                            <article class="entry">
                                <div class="entry-media">
                                    <a >
                                        <img src="/templates/vinass/shop/images4/blog/sidebar-post-1.jpg" alt="Post">
                                    </a>
            ...
            <div class="partners-container">
                <div class="container">
                    <div class="partners-carousel owl-carousel owl-theme">
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/1.png" alt="logo">
                        </a>
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/2.png" alt="logo">
                        </a>
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/3.png" alt="logo">
                        </a>
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/4.png" alt="logo">
                        </a>
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/5.png" alt="logo">
                        </a>
                        <a  class="partner">
                            <img src="/templates/vinass/shop/images4/logos/2.png" alt="logo">
                        </a>
        ...
        <footer class="footer">
            ...
            <div class="container">
                <div class="footer-bottom">
                    ...
                    <img src="/templates/vinass/shop/images4/payments.png" alt="payment methods" class="footer-payments">
    ...
    <!-- Plugins JS File -->
    <script src="/templates/vinass/assets4/js/jquery.min.js"></script>
    <script src="/templates/vinass/assets4/js/bootstrap.bundle.min.js"></script>
    <script src="/templates/vinass/assets4/js/plugins.min.js"></script>

    <!-- Main JS File -->
    <script src="/templates/vinass/assets4/js/main.min.js"></script>
</body>
</html>